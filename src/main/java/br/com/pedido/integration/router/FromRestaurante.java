...
@Component
public class FromRestaurante extends RouteBuilder implements Serializable {
	...
	public void configure() throws Exception {
		from("direct:receberRestaurante").doTry().setHeader(Exchange.HTTP_METHOD, constant(HttpMethods.POST))
